...
import io.github.smolcan.ag_grid_jpa_adapter_showcase.service.docs.CustomFilterService;
...
@RestController()
@RequestMapping("/docs/filtering/column-filter/custom-filter")
...
public class CustomFilterController {
    ...
    public ResponseEntity<LoadSuccessParams> getRows(@RequestBody ServerSideGetRowsRequest request) {
        LoadSuccessParams result = this.customFilterService.getRows(request);
